...
Este é meu portfolio profissional - um site onde apresento my journey como desenvolvedor Python e os projetos que more me orgulho. Foi construído pensando em performance e experiência do usuário, usando tecnologias modernas do frontend.
...
```bash
# Baixar o projeto
git clone https://github.com/Jorge-database/My_portfolio
cd My_Portfolio_Web
...
- **TypeScript** - Para código more seguro
...
- **Projetos** - Os trabalhos que more me orgulho
